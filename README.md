...
<h3 align="center">Software Developer | Java | Spring Boot | React JS | Microservices | AWS</h3>
...
- Multi-module application for Event, Weekend, Tour, and Restaurant bookings.  
- Implemented live chat for real-time query resolution.  
...
- **Tech Stack:** Node.js, Express.js, React Native, MySQL, JWT Authentication, REST APIs, Firebase Notifications, Git
...
- Admin panel for managing users, providers, services, bookings, and payments.  

#### 🔹 Banking Application
- Secure REST APIs using Spring Boot  
- JWT authentication & database optimization  
